...
export const PROOF_OF_CONCEPT_SHIPS: readonly ShipType[] = [
  {
    ...
    supportedModes: ["sublight"], speedByMode: { sublight: 1.5 },
  ...
  },
  {
    ...
    supportedModes: ["sublight", "warp"], speedByMode: { sublight: 1.25, warp: 4.5 },
  ...
  },
  {
    ...
    supportedModes: ["sublight", "warp"], speedByMode: { sublight: 1.8, warp: 7.5 },
  ...
  },
  {
    ...
    supportedModes: ["sublight", "hyperspace"], speedByMode: { sublight: 1.05, hyperspace: 8 },
  ...
  },
  {
    ...
    supportedModes: ["sublight", "hyperspace"], speedByMode: { sublight: 0.8, hyperspace: 6.5 },
  ...
  },
  {
    ...
    speedByMode: { sublight: 1.5, warp: 6.2, hyperspace: 9.5 },
